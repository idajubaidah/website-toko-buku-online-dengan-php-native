...
session_start();
//koneksi ke databse
$koneksi = new mysqli("localhost", "root","","alphabet_store");
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Alphabet Store</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="../img/alphabet2.png" class="user-image img-responsive"/>
					</li>
